...
[Fact(Skip="TODO")]
public void adding_clr_typed_item_with_custom_name_does_not_update_item_matching_clr_type_name_annotationschemaBuilder() {
    // var schema = Schema.Create(schemaBuilder => { });
}
...
[Fact(Skip="TODO")]
public void clr_typed_item_with_conflicting_name_annotation_can_be_added_via_type_param_with_custom_nameschemaBuilder() {
    // var schema = Schema.Create(schemaBuilder => { });
}
...
[Fact(Skip="TODO")]
public void clr_typed_item_with_invalid_name_annotation_can_be_added_via_type_param_with_custom_nameschemaBuilder() {
    // var schema = Schema.Create(schemaBuilder => { });
}
...
[Fact(Skip="TODO")]
public void clr_typed_item_cannot_be_added_with_custom_name_if_named_and_typed_items_already_existschemaBuilder() {
    // var schema = Schema.Create(schemaBuilder => { });
}
...
[Spec(nameof(clr_typed_item_with_name_annotation_cannot_be_added_with_custom_name_if_named_and_typed_items_already_exist))]
[Fact(Skip="TODO")]
public void clr_typed_item_with_name_annotation_cannot_be_added_with_custom_name_if_named_and_typed_items_already_existschemaBuilder() {
    // var schema = Schema.Create(schemaBuilder => { });
}
...
// Source Hash Code: 14394016794075351878