...
namespace GraphZen.TypeSystem.FunctionalTests.Schema_.InputObjects.InputObjectType.Name
{
    [NoReorder]
    public abstract class NameNameSpecsTests
    {
...
// Move NameNameSpecsTests into a separate file to start writing tests
    [NoReorder]
    public class NameNameSpecsTestsScaffold
    {
    }
}
// Source Hash Code: 6579266013876015412