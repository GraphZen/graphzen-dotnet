...
{
    [NoReorder]
    public abstract class FieldSdlSpec
    {
...
// Move FieldSdlSpec into a separate file to start writing tests
    [NoReorder]
    public class FieldSdlSpecScaffold
    {
    }
}
// Source Hash Code: 165647521478710780