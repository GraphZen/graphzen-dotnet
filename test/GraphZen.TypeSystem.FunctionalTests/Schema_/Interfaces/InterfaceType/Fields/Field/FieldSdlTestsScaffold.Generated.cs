...
{
    [NoReorder]
    public abstract class FieldSdlTests
    {
...
// Move FieldSdlTests into a separate file to start writing tests
    [NoReorder]
    public class FieldSdlTestsScaffold
    {
    }
}
// Source Hash Code: 17478335290761366004