...
[Fact(Skip="TODO")]
public void subscriptiontype__element_can_be_defined_via_sdl() {
    // Priority: Low
...
[Fact(Skip="TODO")]
public void subscriptiontype__element_can_be_defined_via_sdl_extension() {
    // Priority: Low
    var schema = Schema.Create(_ => {
...
[Fact(Skip="TODO")]
public void subscriptiontype__optional_item_can_be_removed() {
    // Priority: Low
    var schema = Schema.Create(_ => {
...
[Fact(Skip="TODO")]
public void subscriptiontype__parent_can_be_created_without_optional_item() {
    // Priority: Low
    var schema = Schema.Create(_ => {
...
[Fact(Skip="TODO")]
public void subscriptiontype__updateable_item_can_be_updated() {
    // Priority: Low
    var schema = Schema.Create(_ => {
