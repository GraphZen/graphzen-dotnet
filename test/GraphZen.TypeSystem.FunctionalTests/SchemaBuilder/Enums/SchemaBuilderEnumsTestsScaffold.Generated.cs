...
{
    [NoReorder]
    public abstract class SchemaBuilderEnumsTests
    {
...
// Move SchemaBuilderEnumsTests into a separate file to start writing tests
    [NoReorder]
    public class SchemaBuilderEnumsTestsScaffold
    {
    }
}