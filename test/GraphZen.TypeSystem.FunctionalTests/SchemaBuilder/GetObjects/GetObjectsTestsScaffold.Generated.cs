...
namespace GraphZen.TypeSystem.FunctionalTests.SchemaBuilder.GetObjects {
[NoReorder]
public abstract  class GetObjectsTests {
...
[Fact]
public void clr_typed_item_can_have_type_removed() {
    // Priority: High
    var schema = Schema.Create(_ => {
...
// Move GetObjectsTests into a separate file to start writing tests
[NoReorder] 
public  class GetObjectsTestsScaffold {
}
}
