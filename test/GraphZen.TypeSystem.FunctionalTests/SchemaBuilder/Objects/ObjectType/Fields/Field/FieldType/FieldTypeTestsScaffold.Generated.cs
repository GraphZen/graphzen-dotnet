...
[Fact(Skip="TODO")]
public void fieldtype__element_can_be_defined_via_sdl() {
    // Priority: High
...
[Fact(Skip="TODO")]
public void fieldtype__element_can_be_defined_via_sdl_extension() {
    // Priority: High
    var schema = Schema.Create(_ => {
...
[Fact(Skip="TODO")]
public void fieldtype__required_item_cannot_be_removed() {
    // Priority: High
    var schema = Schema.Create(_ => {
...
[Fact(Skip="TODO")]
public void fieldtype__updateable_item_can_be_updated() {
    // Priority: High
    var schema = Schema.Create(_ => {
