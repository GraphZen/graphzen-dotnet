...
{
    [NoReorder]
    public abstract class InputFieldInputTypeRefTests
    {
    ...
    // Move InputFieldInputTypeRefTests into a separate file to start writing tests
    [NoReorder]
    public class InputFieldInputTypeRefTestsScaffold
    {
    }
}
