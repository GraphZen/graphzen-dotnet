...
{
    [NoReorder]
    public abstract class InputObjectTypeDescriptionTests
    {
...
// Move InputObjectTypeDescriptionTests into a separate file to start writing tests
    [NoReorder]
    public class InputObjectTypeDescriptionTestsScaffold
    {
    }
}