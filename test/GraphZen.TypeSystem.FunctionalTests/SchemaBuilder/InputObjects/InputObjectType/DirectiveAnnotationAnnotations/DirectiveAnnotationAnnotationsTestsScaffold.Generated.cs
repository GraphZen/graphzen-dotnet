...
namespace GraphZen.TypeSystem.FunctionalTests.SchemaBuilder.InputObjects.InputObjectType.DirectiveAnnotationAnnotations
{
    [NoReorder]
    public abstract class DirectiveAnnotationAnnotationsTests
    {
...
// Move DirectiveAnnotationAnnotationsTests into a separate file to start writing tests
    [NoReorder]
    public class DirectiveAnnotationAnnotationsTestsScaffold
    {
    }
}
// Source Hash Code: 10632962499505932421