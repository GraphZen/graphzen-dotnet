...
[NoReorder]
public abstract  class RepeatableTests {

[Spec(nameof(SdlSpec.element_can_be_defined_via_sdl))]
[Fact(Skip="TODO")]
public void repeatable__element_can_be_defined_via_sdl() {
    // Priority: Low
...
[Fact(Skip="TODO")]
public void repeatable__element_can_be_defined_via_sdl_extension() {
    // Priority: Low
    var schema = Schema.Create(_ => {
...
[Fact(Skip="TODO")]
public void repeatable__optional_item_can_be_removed() {
    // Priority: Low
    var schema = Schema.Create(_ => {
...
[Fact(Skip="TODO")]
public void repeatable__parent_can_be_created_without_optional_item() {
    // Priority: Low
    var schema = Schema.Create(_ => {
...
[Fact(Skip="TODO")]
public void repeatable__updateable_item_can_be_updated() {
    // Priority: Low
    var schema = Schema.Create(_ => {
...
// Move RepeatableTests into a separate file to start writing tests
[NoReorder] 
