...
namespace GraphZen.TypeSystem.Tests.Configuration.Directives
{
    ...
    public abstract class Schema_Directives : NamedCollectionConfigurationFixture<IDirectives,
        IDirectivesDefinition, IMutableDirectives, MutableDirectiveDefinition,
        DirectiveDefinition,
        MutableSchema,
        Schema>
    {
        ...
        public override NamedCollection<MutableDirectiveDefinition> GetCollection(MutableSchema parent) =>
            parent.GetDirectives().ToNamedCollection();

        public override NamedCollection<DirectiveDefinition> GetCollection(Schema parent) =>
            parent.GetDirectives().ToNamedCollection();
