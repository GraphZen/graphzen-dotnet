...
namespace GraphZen.TypeSystem.TestSubjectAssemblyA
{
    ...
    {
        public const string ConstructorWithNullableAndNonNullableParameters =
            nameof(ConstructorWithNullableAndNonNullableParameters);
        ...
        public NullableTestClassA(string? nullableRef, string nonNullable, int? nonNullableInt,
            int nonNullableValueTypeInt)
        {
        }
