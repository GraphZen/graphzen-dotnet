...
namespace GraphZen.Types
{
    ...
    public class TypeDiscoveryTests
    {
        ...
        [Theory]
        [InlineData(typeof(object_ignored_by_data_annotation), TypeKind.Object, null, DataAnnotation)]
        [InlineData(typeof(input_object_included_via_field_argument), TypeKind.InputObject, Convention, null)]
        [InlineData(typeof(object_included_by_explicit_configuration), TypeKind.Object, Explicit, DataAnnotation)]
        [InlineData(typeof(object_included_via_method_return_type_on_class), TypeKind.Object, Convention, null)]
        [InlineData(typeof(object_included_via_property_type_on_class), TypeKind.Object, Convention, null)]
        [InlineData(typeof(input_object_ignored_by_data_annotation), TypeKind.InputObject, null, DataAnnotation)]
