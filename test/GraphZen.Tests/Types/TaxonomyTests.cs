...
using Xunit;
using static GraphZen.Types.ClrTypeUtils;
...
namespace GraphZen.Types
{
    public class TaxonomyTests
    {
        ...
        {
            var types = GetImplementedTypes(type).DumpTypes();
            var expected = new[]
            {
                typeof(EnumType),
        ...
        {
            var types = GetImplementedTypes(typeof(IAbstractTypeDefinition));
        ...
        {
            var types = GetImplementedTypes(typeof(IAbstractType));
        ...
        {
            var types = GetImplementedTypes(typeof(IDirectives));
        ...
        {
            var types = GetImplementedTypes(typeof(ICompositeTypeDefinition));
        ...
        {
            var types = GetImplementedTypes(typeof(ICompositeType));
        ...
        {
            var types = GetImplementedTypes(typeof(ILeafTypeDefinition));
        ...
        {
            var types = GetImplementedTypes(typeof(ILeafType));
        ...
        {
            var types = GetImplementedTypes(typeof(INullableType)).DumpTypes();
