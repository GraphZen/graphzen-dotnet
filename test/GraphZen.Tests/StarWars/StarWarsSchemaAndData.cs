...
public abstract class StarWarsSchemaAndData : ExecutorHarness
{
    ...
    private static Human Luke { get; } = new()
    {
        Id = "1000",
        Name = "Luke Skywalker",
    ...
    private static Human Vader { get; } = new()
    {
        Id = "1001",
        Name = "Darth Vader",
        FriendIds = new[] { "1004" },
    ...
    private static Human Han { get; } = new()
    {
        Id = "1002",
        Name = "Han Solo",
    ...
    private static Human Leia { get; } = new()
    {
        Id = "1003",
        Name = "Leia Organa",
    ...
    private static Droid ThreePio { get; } = new()
    {
        Id = "2000",
        Name = "C-3P0",
    ...
    private static Droid Artoo { get; } = new()
    {
        Id = "2001",
        Name = "R2-D2",
    ...
    protected static Task<ICharacter?> GetCharacterAsync(string id) =>
        Task.FromResult<ICharacter?>(HumanData.TryGetValue(id, out var human) ? human :
