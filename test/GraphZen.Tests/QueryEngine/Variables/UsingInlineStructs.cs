...
namespace GraphZen.QueryEngine.Variables
{
    public abstract class UsingInlineStructs : VariablesTests
    {
        ...
        [Fact]
        public Task DoesNotUseIncorrectValue() => ExecuteAsync(@"
              {
        ...
        [Fact]
        public Task ExecutesWithComplextInput() => ExecuteAsync(@"
                    {
        ...
        [Fact]
        public Task ProperlyParsesNullValueInList() => ExecuteAsync(@"
                    {
        ...
        [Fact]
        public Task ProperlyParsesNullValueToNull() => ExecuteAsync(@"
                    {
        ...
        [Fact]
        public Task ProperlyParsesSingleValueToList() => ExecuteAsync(@"
                    {
                        fieldWithObjectInput(input: {a: ""foo"", b: ""bar"", c: ""baz""})
                    }
                    ").ShouldEqual(
        ...
        [Fact]
        public Task ProperlyRunsParseLiteralOnComplexScalarTypes() => ExecuteAsync(@"
                    {
