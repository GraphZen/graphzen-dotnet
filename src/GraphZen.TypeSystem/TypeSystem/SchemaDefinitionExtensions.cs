...
namespace GraphZen.TypeSystem
{
    public static class SchemaDefinitionExtensions
    {
        ...
        {
            return Check.NotNull(schema, nameof(schema)).GetType<UnionTypeDefinition>(name);
        }
        ...
        {
            return Check.NotNull(schema, nameof(schema)).GetType<UnionTypeDefinition>(typeof(TClrType));
        }

        public static UnionTypeDefinition FindUnion(this SchemaDefinition schema, string name)
        {
            return Check.NotNull(schema, nameof(schema)).FindType<UnionTypeDefinition>(name);
        }

        public static UnionTypeDefinition FindUnion<TClrType>(this SchemaDefinition schema)
        {
            return Check.NotNull(schema, nameof(schema)).FindType<UnionTypeDefinition>(typeof(TClrType));
        }
        ...
        {
            return Check.NotNull(schema, nameof(schema)).HasType<UnionTypeDefinition>(typeof(TClrType));
        }
        ...
        {
            return Check.NotNull(schema, nameof(schema)).GetType<ScalarTypeDefinition>(name);
        }
        ...
        {
            return Check.NotNull(schema, nameof(schema)).GetType<ScalarTypeDefinition>(typeof(TClrType));
        }

        public static ScalarTypeDefinition FindScalar(this SchemaDefinition schema, string name)
        {
            return Check.NotNull(schema, nameof(schema)).FindType<ScalarTypeDefinition>(name);
        }

        public static ScalarTypeDefinition FindScalar<TClrType>(this SchemaDefinition schema)
        {
            return Check.NotNull(schema, nameof(schema)).FindType<ScalarTypeDefinition>(typeof(TClrType));
        }
        ...
        {
            return Check.NotNull(schema, nameof(schema)).HasType<ScalarTypeDefinition>(typeof(TClrType));
        }
        ...
        public static InterfaceTypeDefinition GetInterface(this SchemaDefinition schema,
            string name)
        {
            return Check.NotNull(schema, nameof(schema)).GetType<InterfaceTypeDefinition>(name);
        }
        ...
        {
            return Check.NotNull(schema, nameof(schema)).GetType<InterfaceTypeDefinition>(typeof(TClrType));
        }

        public static InterfaceTypeDefinition FindInterface(this SchemaDefinition schema,
            string name)
        {
            return Check.NotNull(schema, nameof(schema)).FindType<InterfaceTypeDefinition>(name);
        }

        public static InterfaceTypeDefinition FindInterface<TClrType>(this SchemaDefinition schema)
        {
            return Check.NotNull(schema, nameof(schema)).FindType<InterfaceTypeDefinition>(typeof(TClrType));
        }
        ...
        {
            return Check.NotNull(schema, nameof(schema)).HasType<InterfaceTypeDefinition>(typeof(TClrType));
        }
        ...
        {
            return Check.NotNull(schema, nameof(schema)).GetType<EnumTypeDefinition>(name);
        }
        ...
        {
            return Check.NotNull(schema, nameof(schema)).GetType<EnumTypeDefinition>(typeof(TClrType));
        }

        public static EnumTypeDefinition FindEnum(this SchemaDefinition schema, string name)
        {
            return Check.NotNull(schema, nameof(schema)).FindType<EnumTypeDefinition>(name);
        }

        public static EnumTypeDefinition FindEnum<TClrType>(this SchemaDefinition schema)
        {
            return Check.NotNull(schema, nameof(schema)).FindType<EnumTypeDefinition>(typeof(TClrType));
        }
        ...
        {
            return Check.NotNull(schema, nameof(schema)).HasType<EnumTypeDefinition>(typeof(TClrType));
        }

        public static bool HasEnum(this SchemaDefinition schema, string name)
        {
            return Check.NotNull(schema, nameof(schema)).HasType<EnumTypeDefinition>(Check.NotNull(name, nameof(name)));
        }


        public static InputObjectTypeDefinition GetInputObject(this SchemaDefinition schema,
            string name)
        {
            return Check.NotNull(schema, nameof(schema)).GetType<InputObjectTypeDefinition>(name);
        }
        ...
        {
            return Check.NotNull(schema, nameof(schema)).GetType<InputObjectTypeDefinition>(typeof(TClrType));
        }

        public static InputObjectTypeDefinition FindInputObject(this SchemaDefinition schema,
            string name)
        {
            return Check.NotNull(schema, nameof(schema)).FindType<InputObjectTypeDefinition>(name);
        }

        public static InputObjectTypeDefinition FindInputObject<TClrType>(this SchemaDefinition schema)
        {
            return Check.NotNull(schema, nameof(schema)).FindType<InputObjectTypeDefinition>(typeof(TClrType));
        }
        ...
        {
            return Check.NotNull(schema, nameof(schema)).HasType<InputObjectTypeDefinition>(typeof(TClrType));
        }
        ...
        {
            return Check.NotNull(schema, nameof(schema)).GetType<ObjectTypeDefinition>(name);
        }
        ...
        {
            return Check.NotNull(schema, nameof(schema)).GetType<ObjectTypeDefinition>(typeof(TClrType));
        }

        public static ObjectTypeDefinition FindObject(this SchemaDefinition schema, string name)
        {
            return Check.NotNull(schema, nameof(schema)).FindType<ObjectTypeDefinition>(name);
        }

        public static ObjectTypeDefinition FindObject<TClrType>(this SchemaDefinition schema)
        {
            return Check.NotNull(schema, nameof(schema)).FindType<ObjectTypeDefinition>(typeof(TClrType));
        }
        ...
        {
            return Check.NotNull(schema, nameof(schema)).HasType<ObjectTypeDefinition>(typeof(TClrType));
        }
