...
namespace GraphZen.TypeSystem
{
    public static class SchemaDefinitionExtensions
    {
        ...
        public static bool HasEnum(this SchemaDefinition schema, string name) => Check.NotNull(schema, nameof(schema))
        ...
        public static bool HasInputObject<TClrType>(this SchemaDefinition schema) => Check
            .NotNull(schema, nameof(schema)).HasType<InputObjectTypeDefinition>(typeof(TClrType));
