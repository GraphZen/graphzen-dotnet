...
public static class SpecScalars
{
    ...
    public static ScalarType String { get; } = ScalarType.Create<string>(_ => _
    ...
    public static ScalarType Int { get; } = ScalarType.Create<int>(_ =>
    {
        _
            ...
            .LiteralParser(node => node is IntValueSyntax ivn ? Maybe.Some<object>(ivn.Value) : Maybe.None<object>())
            .Serializer(value =>
    ...
    public static ScalarType Boolean { get; } = ScalarType.Create<bool>(_ =>
    {
        _.Description(SpecScalarSyntaxNodes.Boolean.Description!.Value)
            ...
            .LiteralParser(node =>
                node is BooleanValueSyntax bvn ? Maybe.Some<object>(bvn.Value) : Maybe.None<object>())
