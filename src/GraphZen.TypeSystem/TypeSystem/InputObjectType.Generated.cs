...
#region DictionaryAccessorGenerator
        ...
        public InputField GetField(String name) 
            => FindField(Check.NotNull(name, nameof(name))) ?? throw new ItemNotFoundException($"{this} does not contain a {nameof(InputField)} with name '{name}'.");
...
// Source Hash Code: 16900483342389753427