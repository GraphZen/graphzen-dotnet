...
namespace GraphZen.TypeSystem
{
    public static class SchemaExtensions
    {
        ...
        public static UnionType GetUnion(this Schema schema, Type clrType) => Check.NotNull(schema, nameof(schema))
            .GetType<UnionType>(Check.NotNull(clrType, nameof(clrType)));
        ...
        public static UnionType? FindUnion(this Schema schema, Type clrType) => Check.NotNull(schema, nameof(schema))
            .FindType<UnionType>(Check.NotNull(clrType, nameof(clrType)));
        ...
        public static bool HasUnion(this Schema schema, Type clrType) => Check.NotNull(schema, nameof(schema))
            .HasType<UnionType>(Check.NotNull(clrType, nameof(clrType)));
        ...
        public static ScalarType GetScalar(this Schema schema, Type clrType) => Check.NotNull(schema, nameof(schema))
            .GetType<ScalarType>(Check.NotNull(clrType, nameof(clrType)));
        ...
        public static ScalarType? FindScalar(this Schema schema, Type clrType) => Check.NotNull(schema, nameof(schema))
            .FindType<ScalarType>(Check.NotNull(clrType, nameof(clrType)));
        ...
        public static bool HasScalar(this Schema schema, Type clrType) => Check.NotNull(schema, nameof(schema))
            .HasType<ScalarType>(Check.NotNull(clrType, nameof(clrType)));
        ...
        public static EnumType GetEnum(this Schema schema, Type clrType) => Check.NotNull(schema, nameof(schema))
            .GetType<EnumType>(Check.NotNull(clrType, nameof(clrType)));
        ...
        public static EnumType? FindEnum(this Schema schema, Type clrType) => Check.NotNull(schema, nameof(schema))
            .FindType<EnumType>(Check.NotNull(clrType, nameof(clrType)));

        public static bool TryGetEnum(this Schema schema, Type clrType, [NotNullWhen(true)] out EnumType? type) => Check
            .NotNull(schema, nameof(schema)).TryGetType(Check.NotNull(clrType, nameof(clrType)), out type);
        ...
        public static bool HasEnum(this Schema schema, Type clrType) => Check.NotNull(schema, nameof(schema))
            .HasType<EnumType>(Check.NotNull(clrType, nameof(clrType)));
        ...
        public static ObjectType GetObject(this Schema schema, Type clrType) => Check.NotNull(schema, nameof(schema))
            .GetType<ObjectType>(Check.NotNull(clrType, nameof(clrType)));
        ...
        public static ObjectType? FindObject(this Schema schema, Type clrType) => Check.NotNull(schema, nameof(schema))
            .FindType<ObjectType>(Check.NotNull(clrType, nameof(clrType)));
        ...
        public static bool HasObject(this Schema schema, Type clrType) => Check.NotNull(schema, nameof(schema))
            .HasType<ObjectType>(Check.NotNull(clrType, nameof(clrType)));
