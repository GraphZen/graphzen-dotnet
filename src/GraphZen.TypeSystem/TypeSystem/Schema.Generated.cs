...
#region DictionaryAccessorGenerator
        ...
        public Directive GetDirective(String name) 
            => FindDirective(Check.NotNull(name, nameof(name))) ?? throw new Exception($"{this} does not contain a {nameof(Directive)} with name '{name}'.");
...
#region DictionaryAccessorGenerator
        ...
        public Directive GetDirective(Type clrType) 
            => FindDirective(Check.NotNull(clrType, nameof(clrType))) ?? throw new Exception($"{this} does not contain a {nameof(Directive)} with clrType '{clrType}'.");
