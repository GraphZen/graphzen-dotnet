...
public static class Introspection
{
    public static Schema Schema { get; } = Schema.Create(sb =>
    {
        sb.Object<IGraphQLType>()
            ...
            .Field("possibleTypes", "[__Type!]", _ => _.Resolve((source, args, context, info) =>
                source is IAbstractType abstractType
    ...
    public static Field SchemaMetaFieldDef { get; } = new("__schema",
    ...
    public static Field TypeNameMetaFieldDef { get; } = new("__typename",
