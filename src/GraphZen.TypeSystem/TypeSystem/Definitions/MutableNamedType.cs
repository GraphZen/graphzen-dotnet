...
namespace GraphZen.TypeSystem
{
    ...
    public abstract class MutableNamedTypeDefinition : MutableAnnotatableMember, IMutableNamedTypeDefinition
    {
        [SuppressMessage("ReSharper", "VirtualMemberCallInConstructor")]
        protected MutableNamedTypeDefinition(TypeIdentity identity, MutableSchema schema,
        ...
        public INamedTypeDefinitionBuilder Builder => GetBuilder();
        protected abstract INamedTypeDefinitionBuilder GetBuilder();
    }
}