...
{
    private readonly Dictionary<string, DirectiveDefinition> _directives = new();

    private readonly Dictionary<string, ConfigurationSource> _ignoredDirectives = new();

    private readonly Dictionary<string, ConfigurationSource> _ignoredTypes = new();

    private readonly List<TypeIdentity> _typeIdentities;
    private readonly List<NamedTypeDefinition> _types = new();
