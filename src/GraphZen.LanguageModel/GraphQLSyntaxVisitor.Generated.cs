...
namespace GraphZen.LanguageModel
{
    public abstract partial class GraphQLSyntaxVisitor
    {
        ...
        public virtual void EnterInputObjectTypeDefinition([NotNull] InputObjectTypeDefinitionSyntax node) =>
            OnEnter(node);

        /// <summary>Called when the visitor leaves a <see cref="InputObjectTypeDefinitionSyntax" /> node.</summary>
        public virtual void LeaveInputObjectTypeDefinition([NotNull] InputObjectTypeDefinitionSyntax node) =>
            OnLeave(node);

        /// <summary>Called when the visitor enters a <see cref="InputObjectTypeExtensionSyntax" /> node.</summary>
        public virtual void EnterInputObjectTypeExtension([NotNull] InputObjectTypeExtensionSyntax node) =>
            OnEnter(node);

        /// <summary>Called when the visitor leaves a <see cref="InputObjectTypeExtensionSyntax" /> node.</summary>
        public virtual void LeaveInputObjectTypeExtension([NotNull] InputObjectTypeExtensionSyntax node) =>
            OnLeave(node);
    ...
    public abstract partial class GraphQLSyntaxVisitor<TResult>
    {
        ...
        /// <summary>Called when the visitor enters a <see cref="InputObjectTypeDefinitionSyntax" /> node.</summary>
        public virtual TResult EnterInputObjectTypeDefinition([NotNull] InputObjectTypeDefinitionSyntax node) =>
            OnEnter(node);

        /// <summary>Called when the visitor leaves a <see cref="InputObjectTypeDefinitionSyntax" /> node.</summary>
        public virtual TResult LeaveInputObjectTypeDefinition([NotNull] InputObjectTypeDefinitionSyntax node) =>
            OnLeave(node);

        /// <summary>Called when the visitor enters a <see cref="InputObjectTypeExtensionSyntax" /> node.</summary>
        public virtual TResult EnterInputObjectTypeExtension([NotNull] InputObjectTypeExtensionSyntax node) =>
            OnEnter(node);

        /// <summary>Called when the visitor leaves a <see cref="InputObjectTypeExtensionSyntax" /> node.</summary>
        public virtual TResult LeaveInputObjectTypeExtension([NotNull] InputObjectTypeExtensionSyntax node) =>
            OnLeave(node);
        ...
        /// <summary>Called when the visitor enters a <see cref="InterfaceTypeDefinitionSyntax" /> node.</summary>
        public virtual TResult EnterInterfaceTypeDefinition([NotNull] InterfaceTypeDefinitionSyntax node) =>
            OnEnter(node);

        /// <summary>Called when the visitor leaves a <see cref="InterfaceTypeDefinitionSyntax" /> node.</summary>
        public virtual TResult LeaveInterfaceTypeDefinition([NotNull] InterfaceTypeDefinitionSyntax node) =>
            OnLeave(node);

        /// <summary>Called when the visitor enters a <see cref="InterfaceTypeExtensionSyntax" /> node.</summary>
        public virtual TResult EnterInterfaceTypeExtension([NotNull] InterfaceTypeExtensionSyntax node) =>
            OnEnter(node);

        /// <summary>Called when the visitor leaves a <see cref="InterfaceTypeExtensionSyntax" /> node.</summary>
        public virtual TResult LeaveInterfaceTypeExtension([NotNull] InterfaceTypeExtensionSyntax node) =>
            OnLeave(node);
        ...
        /// <summary>Called when the visitor enters a <see cref="OperationTypeDefinitionSyntax" /> node.</summary>
        public virtual TResult EnterOperationTypeDefinition([NotNull] OperationTypeDefinitionSyntax node) =>
            OnEnter(node);

        /// <summary>Called when the visitor leaves a <see cref="OperationTypeDefinitionSyntax" /> node.</summary>
        public virtual TResult LeaveOperationTypeDefinition([NotNull] OperationTypeDefinitionSyntax node) =>
            OnLeave(node);
