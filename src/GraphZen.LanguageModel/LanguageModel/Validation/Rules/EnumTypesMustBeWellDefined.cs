...
{
    private readonly Dictionary<string, ICollection<EnumTypeDefinitionSyntax>> _enumDefs = new();


    private readonly Dictionary<string, ICollection<EnumTypeExtensionSyntax>> _enumExts = new();
