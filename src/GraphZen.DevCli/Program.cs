...
namespace GraphZen
{
    internal class Program
    {
        private static void Main(string[] args)
        {
            ...
            {
                new Command("GenChanged") {Handler = CommandHandler.Create(() => CodeGenerator.Generate(true))},
                new Command("Gen") {Handler = CommandHandler.Create(() => CodeGenerator.Generate(false))},
