...
namespace GraphZen.TypeSystem {
 ...
 public static partial class InterfaceTypeDefinitionFieldsAccessorExtensions {
        ...
        public static bool TryGetField( this InterfaceTypeDefinition source,  string name, [NotNullWhen(true)] out FieldDefinition? fieldDefinition)
 ...
 public static partial class ObjectTypeDefinitionFieldsAccessorExtensions {
        ...
        public static bool TryGetField( this ObjectTypeDefinition source,  string name, [NotNullWhen(true)] out FieldDefinition? fieldDefinition)
             => source.Fields.TryGetValue(Check.NotNull(name, nameof(name)), out fieldDefinition);
}
 ...
 public static partial class InputObjectTypeDefinitionFieldsAccessorExtensions {
        ...
        public static bool TryGetField( this InputObjectTypeDefinition source,  string name, [NotNullWhen(true)] out InputFieldDefinition? inputFieldDefinition)
 ...
 public static partial class FieldsContainerDefinitionFieldsAccessorExtensions {
        ...
        public static bool TryGetField( this FieldsContainerDefinition source,  string name, [NotNullWhen(true)] out FieldDefinition? fieldDefinition)
             => source.Fields.TryGetValue(Check.NotNull(name, nameof(name)), out fieldDefinition);
}
