...
{
    public abstract class InputObjectTypeDescriptionTestsBase : LeafElementConfigurationTests<IDescription,
        IMutableDescription, InputObjectTypeDefinition, InputObjectType>
    {
        [Fact]
