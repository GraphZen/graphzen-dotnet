...
{
    public abstract class InterfaceTypeDescriptionTestsBase : LeafElementConfigurationTests<IDescription,
        IMutableDescription, InterfaceTypeDefinition, InterfaceType>
    {
        [Fact]
