...
{
    public abstract class Object_Field_Argument_Description : LeafElementConfigurationFixture<IDescription, IDescription, IMutableDescription,
        string, ArgumentDefinition, Argument>
    {
        ...
        public override ArgumentDefinition GetParent(SchemaBuilder sb, string parentName) =>
            sb.GetDefinition().GetObject(GreatGrandparent).GetField(Grandparent).GetArgument(parentName);
