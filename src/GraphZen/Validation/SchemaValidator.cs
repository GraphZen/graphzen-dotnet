...
namespace GraphZen.Validation
{
    ...
    {
        public SchemaValidator([CanBeNull] IReadOnlyCollection<ValidationRule> rules)
        {
            Rules = rules ?? ValidationRules.SpecifiedSchemaRules;
        }
            ...
            DocumentSyntax initialSchemaDocument = null)
        {
            ...
            var validationContext = new SchemaValidationContext(schemaDocument, initialSchemaDocument,
