...
{
    public class ObjectFieldsMustHaveOutputTypes : SchemaValidationRuleVisitor
    {
        public ObjectFieldsMustHaveOutputTypes(SchemaValidationContext context) : base(context)
        {
        }
