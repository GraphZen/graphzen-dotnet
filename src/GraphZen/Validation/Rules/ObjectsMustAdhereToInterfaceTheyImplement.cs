...
{
    public class ObjectsMustAdhereToInterfaceTheyImplement : SchemaValidationRuleVisitor
    {
        public ObjectsMustAdhereToInterfaceTheyImplement(SchemaValidationContext context) : base(context)
        {
        }
