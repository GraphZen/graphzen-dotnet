...
{
    public class SchemaMustHaveRootObjectTypes : SchemaValidationRuleVisitor
    {
        private SchemaDefinitionSyntax _schema;

        public SchemaMustHaveRootObjectTypes(SchemaValidationContext context) : base(context)
        {
        }
