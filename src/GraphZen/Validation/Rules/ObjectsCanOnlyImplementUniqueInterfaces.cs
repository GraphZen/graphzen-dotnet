...
{
    public class ObjectsCanOnlyImplementUniqueInterfaces : SchemaValidationRuleVisitor
    {
        public ObjectsCanOnlyImplementUniqueInterfaces(SchemaValidationContext context) : base(context)
        {
        }
