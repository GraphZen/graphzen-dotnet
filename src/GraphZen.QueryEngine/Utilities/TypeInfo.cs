...
{
    private readonly Stack<Maybe<object>?> _defaultValueStack = new();

    private readonly Stack<Field?> _fieldDefStack = new();

    private readonly Stack<IGraphQLType?> _inputTypeStack = new();

    private readonly Stack<ICompositeType?> _parentTypeStack = new();
