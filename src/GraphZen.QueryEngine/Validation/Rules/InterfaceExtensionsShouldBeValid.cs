...
{
    public class InterfaceExtensionsShouldBeValid : SchemaValidationRuleVisitor
    {
        public InterfaceExtensionsShouldBeValid(SchemaValidationContext context) : base(context)
        {
        }
