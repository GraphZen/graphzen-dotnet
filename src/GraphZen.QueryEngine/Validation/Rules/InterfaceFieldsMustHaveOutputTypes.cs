...
{
    public class InterfaceFieldsMustHaveOutputTypes : SchemaValidationRuleVisitor
    {
        public InterfaceFieldsMustHaveOutputTypes(SchemaValidationContext context) : base(context)
        {
        }
