...
{
    public class FieldArgumentsMustHaveInputTypes : SchemaValidationRuleVisitor
    {
        public FieldArgumentsMustHaveInputTypes(SchemaValidationContext context) : base(context)
        {
        }
